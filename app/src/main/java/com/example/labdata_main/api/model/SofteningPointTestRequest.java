...
public class SofteningPointTestRequest {
    ...
    @SerializedName("softening_temperature")
    ...
    public String getSofteningTemperature() { return softeningTemperature; }
    public void setSofteningTemperature(String softeningTemperature) { this.softeningTemperature = softeningTemperature; }
